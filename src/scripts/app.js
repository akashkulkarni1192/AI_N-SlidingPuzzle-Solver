System.register(["./main", "./AppConstants"], function (exports_1, context_1) {
    "use strict";
    ...
    function bootstrapPuzzle() {
        clearPuzzle();
        var puzzleSize = AppConstants_1.AppConstants.defaultPuzzleSize;
        var puzzleSizeElement = document.getElementById("puzzleSize");
        if (puzzleSizeElement) {
            puzzleSizeElement.setAttribute("min", AppConstants_1.AppConstants.minPuzzleSize.toString());
            puzzleSizeElement.setAttribute("max", AppConstants_1.AppConstants.maxPuzzleSize.toString());
            if (puzzleSizeElement.value == "") {
                puzzleSizeElement.value = puzzleSize;
            }
            else {
                puzzleSize = parseInt(puzzleSizeElement.value);
            }
        }
        if (puzzleSize >= AppConstants_1.AppConstants.minPuzzleSize && puzzleSize <= AppConstants_1.AppConstants.maxPuzzleSize) {
            var main = new main_1.Main(puzzleSize);
            renderPuzzle(main);
        }
    }
    var main_1, AppConstants_1;
    return {
        setters: [
            function (main_1_1) {
                main_1 = main_1_1;
